    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            b.group(group)
             ...
             .handler(new Socks5ClientInitializer(sslCtx, DST_ADDR, DST_PORT));

            // Start the connection attempt.
            Channel ch = b.connect(PROXY_HOST, PROXY_PORT).sync().channel();
            ch.writeAndFlush(new DefaultSocks5InitialRequest(Socks5AuthMethod.NO_AUTH));
